...
public class MappingProducerSave<T> implements Flow.Publisher<T> {
  private final Flow.Publisher<T> source;

  private MappingProducerSave(Flow.Publisher<T> source) {
    this.source = source;
  }
  ...
  // -----------------------------------------------------------
  public static <T> MappingProducerSave<T> just(T value) {
    return new MappingProducerSave<>(subscriber -> {
  ...
  // Static Factory
  public static <T> MappingProducerSave<T> from(Flow.Publisher<T> source) {
    return new MappingProducerSave<>(source);
  }
  ...
  // -----------------------------------------------------------
  public <R> MappingProducerSave<R> map(Function<T, R> mapper) {
    ...
    return new MappingProducerSave<>(mappedSource);
  }
