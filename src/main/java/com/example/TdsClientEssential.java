    ...
    return Mono.defer(() -> {
        ...
        .then(Mono.defer(() -> {
          Statement stmt3 = connection.createStatement(bindSql)
              ...
              .bind(17, Parameters.in(R2dbcType.VARCHAR, "A".repeat(5000)))
              ...
              .bind(21, Parameters.in(R2dbcType.NVARCHAR, "あ".repeat(4000)))
              .bind(22, Parameters.in(R2dbcType.BINARY, ByteBuffer.wrap(new byte[]{(byte)0xDE, (byte)0xAD, (byte)0xBE, (byte)0xEF})))
              .bind(23, Parameters.in(R2dbcType.VARBINARY, ByteBuffer.wrap(new byte[]{(byte)0xCA, (byte)0xFE, (byte)0xBA, (byte)0xBE})))
              .bind(24, Parameters.in(R2dbcType.VARBINARY, ByteBuffer.wrap(new byte[]{(byte)0xFE, (byte)0xED, (byte)0xBA, (byte)0xCC})))
              .bind(25, Parameters.in(R2dbcType.VARBINARY, ByteBuffer.wrap(new byte[]{(byte)0x00, (byte)0x11, (byte)0x22, (byte)0x33})))
              .bind(26, Parameters.in(R2dbcType.CHAR, UUID.randomUUID()));
        ...
        .then(Mono.defer(() -> {
          Statement stmt4 = connection.createStatement(bindSql)
              ...
              .bind(17, "A".repeat(5000))
              .bind(18, "Legacy Text Data")
              .bind(19, "FixedUni")
              .bind(20, "Unicode String")
              .bind(21, "あ".repeat(4000))
              .bind(22, ByteBuffer.wrap(new byte[]{(byte)0xDE, (byte)0xAD, (byte)0xBE, (byte)0xEF}))
...
//  );
  ...
  private static final String bindSqlNames = """
    INSERT INTO dbo.AllDataTypes (
      ...
      test_varbinary_max, test_image, test_guid
    ) VALUES (
  @test_bit, @test_tinyint, @test_smallint, @test_int, @test_bigint, @test_decimal, @test_numeric,
  @test_money, @test_real, @test_float, @test_date, @test_time, @test_datetime,
  @test_datetime2, @test_smalldatetime, @test_char, @test_varchar, @test_varchar_max,
